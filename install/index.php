        ...
        <div class="site-wrapper-inner">
            ...
            <div class="cover-container">
                ...
                <div class="masthead clearfix">
                    <div class="inner">
						<nav>
							 <ul  style="float:left"  class="nav masthead-nav">
                        ...
                        <nav>
                            ...
                            <ul  style="float:right"  class="nav masthead-nav">
...
<br><br>
                <div class="inner cover">
                    <h1 class="cover-heading">个人主页</h1>
                    <p class="lead"><br>
                        Tip: 简约精致,还得看我们！<br><br>2022~ 新款个人主页~</p>
                </div>
		...
		<br><br>
		 ...
		 <p class="lead" align="center">
                        <a href="index.php?do=1"  class="btn btn-lg btn-default">开始安装</a>
                    </p>
		</div>
		<br><br>
		<br><br>
		...
		<div class="mastfoot">
                    <div class="inner">
                      <footer>
                        <p>本网站由个人主页程序提供服务, Copyright  © 2022 <a   target="_blank"  href="http://wang77.cc">7c工作室</a></p>
                   </footer>
                        </div>
                </div>
		<?php }?>
...
<div class="inner cover">
	<div class="lead">
		<h3 class="cover-heading" align="center">环境检查</h3>
	</div>
...
<table class="form-group">
	<thead>
		<tr>
			...
			<th style="width:36%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;需求</th>
			<th style="width:35%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前</th>
	...
	<tbody>
		...
		<tr>
			<td>fwrite()</td>
				<td>必须</td>
				<td><?php if (is_writable('./')) { echo '<font>可用</font>'; } else { echo '<font color="black">不支持</font>'; } ?></td>
				<td>写入权限</td>
		</tr>
	</tbody>
</table>
<p><span  style="float:left;"><a class="btn btn-primary" href="index.php?do=0"><<上一步</a></span>
...
<div class="inner cover">
	<div class="lead">
		<h3 class="cover-heading" align="center">数据库配置</h3>
	</div>
...
<div class="inner cover">
	<div class="lead">
		<h3 class="cover-heading" align="center">保存数据库</h3>
	</div>
<div class="progress progress-striped">
	...
	if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
		...
		if(!$con=DB::connect($dbconfig['host'],$dbconfig['user'],$dbconfig['pwd'],$dbconfig['dbname'],$dbconfig['port'])){
			...
			if(DB::query("select * from qiu_config where 1")==FALSE)
				...
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过汇乐导航1.0系统</div>
...
<div class="inner cover">
	<div class="lead">
		<h3 class="cover-heading" align="center">保存数据表</h3>
	</div>
<div class="progress progress-striped">
...
<div class="inner cover">
	<div class="lead">
		<h3 class="cover-heading" align="center">安装完成</h3>
	</div>
<div class="progress progress-striped">
...
<?php
	...
	echo '<div class="inner cover"><font>安装完成！管理账号和密码是:admin/123456</font><br/><br/><a  class="input-group-addon" href="../">>>网站首页</a>｜<a class="input-group-addon" href="../admin/">>>后台管理</a><hr/>更多设置选项请登录后台管理进行修改。<br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录建立 install.lock 文件！</font></div>';
?>
	</div>
</div>
...
<?php
	@file_put_contents("install.lock",'安装锁');
	echo '<div class="alert alert-info"><font color="green">安装完成！管理账号和密码是:admin/admin</font><br/><br/><a href="../">>>网站首页</a>｜<a href="../qiuadmin/">>>后台管理</a><hr/>更多设置选项请登录后台管理进行修改。<br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录建立 install.lock 文件！</font></div>';
?>
			</div>
		</div>
	</div>
